...
public class Main {
	...
	public static void main(String[] args) throws IOException{ 
		...
		BufferedReader bf = new BufferedReader(new FileReader("/Users/jeongsebin/Documents/KoreanWave2021.txt"));
		...
		//선택한 부문에 따라서 값을 출력
		//입력한 값과 동일한 키값을 가진 hashMap의 value 값을 각 부문의 ___List객체에 저장 후 Display함수를 통해 출력
		switch(selectD) { 
			case "1":
